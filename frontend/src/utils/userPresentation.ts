...
type UserLike = Partial<Pick<UserProfile, 'displayName' | 'studentId' | 'email' | 'creditScore' | 'verificationStatus' | 'college'>>
  | Partial<Pick<UserTrustSummary, 'displayName' | 'studentId' | 'email' | 'creditScore' | 'verificationStatus' | 'college'>>
  | (Partial<Pick<SessionUser, 'displayName' | 'studentId' | 'email' | 'creditScore' | 'verificationStatus'>> & { college?: string });
