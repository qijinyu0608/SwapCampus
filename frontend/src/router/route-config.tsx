...
export const appRoutes: AppRouteDefinition[] = [
  ...
  { path: '/campus-services/:id/edit', element: <RequireUser><CampusServicePublishPage /></RequireUser> },
  ...
  { path: '/products/:id/edit', element: <RequireUser><ProductPublishPage /></RequireUser> },
