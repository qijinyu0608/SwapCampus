...
const SAMPLE_CATALOG = [
  ...
  { title: '机械键盘 87 配列', category: '数码电子', condition: '8成新', price: 86, tags: ['键盘', '宿舍桌搭'], description: '青轴手感清晰，接口正常。' },
  { title: '蓝牙鼠标', category: '数码电子', condition: '9成新', price: 29, tags: ['鼠标', '蓝牙'], description: '轻度使用，电池仓正常。' },
  { title: '插电护眼台灯', category: '宿舍生活', condition: '9成新', price: 35, tags: ['台灯', '书桌'], description: '插电款，亮度稳定，适合宿舍学习。' },
